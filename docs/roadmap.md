...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、版面列表、版面页、主题列表、主题阅读页、新帖页、关注聚合页、随机精选页、场景化搜索、用户中心首页、公开用户页、资料设置、主题中心、“我的主题”、“我的回复”、“我的足迹”、“我的收藏”、“关注版面”和“关注用户”，下一步恢复“我的粉丝”和其余用户中心子页。
