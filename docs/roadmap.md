...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、版面列表、版面页、主题列表、主题阅读页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、年度总结、完整错误页、站点管理、用户管理，以及完整的主题、楼层、版面批量管理。活动路由审计已经完成，下一步迁移剩余皮肤并执行全站回归。
...
主题级版务已经恢复锁定、热门控制、删除、移动、提升、两级固顶、精华、高亮、管理记录和 IP 分组，并按完整管理权限与主题作者权限区分入口。楼层管理恢复奖励财富、奖励威望、扣除财富、扣除威望、删除、TP 和解除 TP；版面页恢复主题勾选、批量锁沉和批量删除。用户管理只对管理员开放，已恢复全站锁定、屏蔽、TP、解除处罚、删除近期内容和查看近期发言。2025 年度总结已恢复原站竖版卡片、条件分页和活动图片。旧 `/annual-review-2022` 线上为 404，`/index` 是空页面，两者不迁移。高风险写入只在本地 mock 验证。阶段 8 还需完成剩余皮肤和全站回归。
