...
- 已建立 `packages/api`，覆盖 136 个 operation、116 个 path；OpenAPI 当前包含 69 个从 operation 可达的组件 schema。
...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、版面列表、版面页、主题列表、主题阅读页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、完整错误页和站点管理。下一步进入版务工具与活动页面迁移。
