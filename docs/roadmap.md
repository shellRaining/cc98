...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、登录页、三类热门页、版面列表、版面页、主题列表、主题阅读页、发主题与编辑页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、年度总结、完整错误页、站点管理、用户管理，以及完整的主题、楼层、版面批量管理。活动路由审计、全部旧站皮肤、公开用户页与主题楼层的头像框也已经完成，新帖、关注、精选、用户中心和年度总结的匿名入口已统一恢复原站完整 401 状态，下一步继续执行全站权限、路由、交互、视觉和控制台回归。
