...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、版面列表、版面页、主题列表、主题阅读页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、完整错误页、站点管理、主题版务和楼层管理。下一步迁移版面批量操作和用户管理。
...
主题级版务已经恢复锁定、热门控制、删除、移动、提升、两级固顶、精华、高亮、管理记录和 IP 分组，并按完整管理权限与主题作者权限区分入口。楼层管理恢复奖励财富、奖励威望、扣除财富、扣除威望、删除、TP 和解除 TP。高风险写入只在本地 mock 验证。阶段 8 还需完成版面批量操作、用户管理、年度总结、活动页和剩余皮肤。
