...
- 已建立 `packages/api`，覆盖 136 个 operation、116 个 path；OpenAPI 当前包含 70 个从 operation 可达的组件 schema。
...
阶段 0 至阶段 7 已完成，阶段 8 主题、活动与样式收尾正在进行。全站高保真迁移已完成首页、页面壳、版面列表、版面页、主题列表、主题阅读页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、完整错误页、站点管理和主题级版务工具。下一步迁移楼层管理、版面批量操作和用户管理。
...
主题级版务已经恢复锁定、热门控制、删除、移动、提升、两级固顶、精华、高亮、管理记录和 IP 分组，并按完整管理权限与主题作者权限区分入口。高风险写入只在本地 mock 验证。阶段 8 还需完成楼层管理、版面批量操作、用户管理、年度总结、活动页和剩余皮肤。
