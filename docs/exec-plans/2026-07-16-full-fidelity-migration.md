...
| 消息             | 回复、@、系统、私信、设置                                                                          | 四类页面与头部消息下拉已恢复，没有消息设置                             | 补设置并调整消息页列表密度                 |
...
1. `M6` 用户中心：恢复个人内容、关注关系、财富转移和低频设置。
...
- 2026-07-18：下拉支持鼠标悬停与键盘聚焦，收起时不会留下可聚焦的隐藏链接。浏览器确认四类入口、零未读状态、1440px 和 1140px 布局，控制台无错误或警告；取证截图保存在 `.artifacts/browser/2026-07-18-message-fidelity/header-message-dropdown.png`，下一切片进入消息页与消息设置。
