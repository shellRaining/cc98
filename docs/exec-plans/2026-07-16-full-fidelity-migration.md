...
| 主题阅读         | 主题信息区、用户侧栏、头像相框、等级资料、楼层、签名、奖励、赞踩、引用、只看、评分、管理、热门回复 | 已恢复阅读骨架、主要楼层互动、主题管理、管理记录和 IP 分组   | 主题级能力已完成，楼层管理继续归入 M8      |
...
| 版主管理         | 置顶、锁定、精华、移动、高亮、批量操作、禁言、版务记录                                             | 主题管理和管理记录已恢复，楼层与版面批量操作尚未迁移         | 按主题、楼层、版面三个切片继续推进         |
...
截至 2026-07-18，错误页、站点管理和主题级版务工具已经完成。主题页会按管理员、超级版主、当前版主和主题作者权限显示入口，完整权限可执行锁定、热门控制、删除、移动、提升、两级固顶、精华和高亮，并查看 7 条分页的管理记录与 IP 分组。剩余范围是楼层管理、版面批量操作、用户管理、年度总结和仍在线的活动页。
...
1. `M8` 楼层与版面管理：恢复楼层奖励、惩罚、删除、禁言和版面批量操作。
2. `M8` 用户管理：恢复公开用户页和管理入口中的账号、财富与权限操作。
3. `M8` 活动页：迁移年度总结和仍在线的节日活动，再进入 `M9` 全皮肤与回归。
