...
截至 2026-07-18，错误页、站点管理、版务工具和用户管理已经完成。主题页会按管理员、超级版主、当前版主和主题作者权限显示入口，完整权限可执行锁定、热门控制、删除、移动、提升、两级固顶、精华和高亮，并查看 7 条分页的管理记录与 IP 分组。楼层管理恢复奖励、惩罚、删除、TP 和解除 TP，版面页恢复主题勾选、批量锁沉和批量删除。用户管理只对管理员开放，包含全站锁定、屏蔽、TP、解除处罚、删除近期主题与回复，以及每页 10 条的近期发言查询。剩余范围是年度总结和仍在线的活动页。
