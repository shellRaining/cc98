...
| 版主管理         | 置顶、锁定、精华、移动、高亮、批量操作、禁言、版务记录                                             | 主题和楼层管理已恢复，版面批量操作尚未迁移                   | 下一切片恢复版面批量锁沉和删除             |
...
截至 2026-07-18，错误页、站点管理、主题级版务和楼层管理已经完成。主题页会按管理员、超级版主、当前版主和主题作者权限显示入口，完整权限可执行锁定、热门控制、删除、移动、提升、两级固顶、精华和高亮，并查看 7 条分页的管理记录与 IP 分组。楼层管理恢复奖励、惩罚、删除、TP 和解除 TP。剩余范围是版面批量操作、用户管理、年度总结和仍在线的活动页。
