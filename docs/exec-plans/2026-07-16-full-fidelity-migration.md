...
| 版主管理         | 置顶、锁定、精华、移动、高亮、批量操作、禁言、版务记录                                             | 主题、楼层和版面批量操作均已恢复                             | 版务工具已完成，下一步迁移用户管理         |
...
截至 2026-07-18，错误页、站点管理和版务工具已经完成。主题页会按管理员、超级版主、当前版主和主题作者权限显示入口，完整权限可执行锁定、热门控制、删除、移动、提升、两级固顶、精华和高亮，并查看 7 条分页的管理记录与 IP 分组。楼层管理恢复奖励、惩罚、删除、TP 和解除 TP，版面页恢复主题勾选、批量锁沉和批量删除。剩余范围是用户管理、年度总结和仍在线的活动页。
...
1. `M8` 用户管理：恢复公开用户页和管理入口中的账号、财富与权限操作。
2. `M8` 活动页：迁移年度总结和仍在线的节日活动。
3. `M9` 全皮肤与回归：完成剩余皮肤和全站浏览器验收。
