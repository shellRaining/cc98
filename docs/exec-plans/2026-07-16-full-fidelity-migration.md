...
- 2026-07-18：浏览器对照用户 `762741` 确认资料页头像为 160px、版主框为 240px，楼层头像为 80px、版主框为 122.24px。1140px 与 1440px 无横向溢出或破图，版主版面链接保持 SPA 导航，取证保存在 `.artifacts/browser/2026-07-18-avatar-frame-fidelity/`。下一处明确差异是版面搜索空结果：原站使用 `searchNone.png` 和完整空状态，当前只显示文字。
