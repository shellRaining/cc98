...
| 消息             | 回复、@、系统、私信、设置                                                                          | 头部下拉和三类通知列表已高保真恢复，私信仍沿用功能版，没有消息设置     | 继续恢复私信与设置                         |
...
1. `M7` 私信与消息设置：恢复私信列表、会话、发送流程和本地通知偏好。
...
- 2026-07-18：浏览器确认回复第二页 3 条、@ 第二页 1 条、系统通知标题与相关主题入口。一键已读同时调用三个分类接口，头部、导航和三类列表同步清零；匿名来源页、1440px、1140px 和控制台均通过验证，取证保存在 `.artifacts/browser/2026-07-18-message-fidelity/`，下一切片进入私信页与消息设置。
