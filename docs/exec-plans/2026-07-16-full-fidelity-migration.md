...
| 版面页           | 版面信息、标签、精华、保留、版务记录、置顶、搜索、发帖、关注、管理入口                             | 紧凑头区、两层标签、精华、保留、记录、置顶和管理均已恢复             | 已完成，批量操作只对有权限用户显示         |
| 主题列表项       | 状态图标、标题高亮、作者、时间、回复/浏览、最后回复、分页快捷入口                                  | 64px 主题行、置顶图标、高亮、标签和完整元信息已恢复                  | 已完成，后续只做长文本与空状态回归         |
| 主题阅读         | 主题信息区、用户侧栏、头像相框、等级资料、楼层、签名、奖励、赞踩、引用、只看、评分、管理、热门回复 | 楼层网格、头像框、互动、签名、投票、热评、管理记录与 IP 分组均已恢复 | 已完成，保留 Markdown 与 UBB 共享渲染层    |
