...
- [x] 更新 `docs/roadmap.md`，阶段 3 完成后切换当前阶段为阶段 4。
...
- [x] 阶段完成后更新 `docs/roadmap.md` 状态和相关执行计划链接。
