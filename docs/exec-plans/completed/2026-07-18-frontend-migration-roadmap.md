...
- 已建立 `packages/api`，覆盖 136 个 operation、116 个 path；OpenAPI 当前包含 74 个从 operation 可达的组件 schema。
...
阶段 0 至阶段 8 已完成。全站高保真迁移覆盖首页、页面壳、登录页、三类热门页、版面列表、版面页、主题列表、主题阅读页、发主题与编辑页、新帖页、关注聚合页、随机精选页、场景化搜索、完整用户中心、消息中心、签到页、年度总结、完整错误页、站点管理、用户管理，以及主题、楼层和版面批量管理。活动路由、全部旧站皮肤、头像框、长内容、匿名权限入口和页脚均已完成审计。最终浏览器矩阵覆盖匿名、登录、管理员、1440px、1140px 和夏季深色皮肤，没有横向溢出、破图或未处理控制台告警。
